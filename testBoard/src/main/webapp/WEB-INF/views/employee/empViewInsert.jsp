...
$(function(){
	//chapter2
	// 유효성 검사 확인
	var kor_Name_Flag = false;
	var eng_Name_Flag = false;
	var chn_Name_Flag = false; 
	var tech_Lev_Flag = false; 
	var jumin_Nof_Flag = false; 
	var jumin_Nob_Flag = false; 
	...
	$("#bt_insertSubmit").click(function(){
		// 한글 이름
		if(kor_Name.val() == ""){
			alert("한글 이름을 입력해주세요.");
			kor_Name.focus();
		...
		if(jumin_Nof.val() == "" || jumin_Nob.val() == ""){
			...
			if(!jumin_Nof_Flag || !jumin_Nob_Flag){
		...
		if(kor_Name_Flag && eng_Name_Flag && chn_Name_Flag && tech_Lev_Flag && 
		   ...
		   work_Year_Flag && phone1_Flag && phone2_Flag && phone3_Flag){
			var insertConf = confirm("사원을 등록하시겠습니까?");
			if(insertConf==true){
				var f =  document.insertForm;
				f.method="post";
				f.enctype="multipart/form-data";
				f.action="${pageContext.request.contextPath}/employee/empViewInsert_ok";
				f.submit();
			}else{
				insertConf.close();
			}		
	...
	$("#uploadExcel").click(function(){
		...
		location.href = "${pageContext.request.contextPath}/employee/excelFileUpload";
	});
	
	// 엑셀로 불러온 데이터 입력
	if("${sawonDTO.work_Year}" == "null"){
		$("#work_Year").val("");
	}
	if("${sawonDTO.address}" == "null"){
		$("#address").val("");
	}
	if("${sawonDTO.email}" == "null"){
		$("#email").val("");
	}
	if("${sawonDTO.liquor}" == "null"){
		$("#liquor").val("");
	}
	

	if("${sawonDTO.sol_Flag}" == "양력"){
		$("#sol_Flag_Sun").attr({
			checked: "checked"
		}); 
	}else if("${sawonDTO.sol_Flag}" == "음력"){
		$("#sol_Flag_Moon").attr({
			checked: "checked"
		});
	...
	}else if("${sawonDTO.sex}" == "여자"){
		$("#sex_Woman").attr({
			checked: "checked"
		});
	} 
	if("${sawonDTO.marry_Flag}" == "무"){
		$("#marry_Flag_No").attr({
			checked: "checked"
		});
	}else if("${sawonDTO.marry_Flag}" == "유"){
		$("#marry_Flag_Yes").attr({
			checked: "checked"
		});
	} 
	if("${sawonDTO.payment_Type}" != ""){
      ...
      -
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="526" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="268"><input type="text" size="40" id="file_Txt" name="file_Txt"></td>
                    ...
                    <tr>
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="391"><input id="birth1" name="birth1" type="text" value="${sawonDTO.birth1}" size="10" maxlength="4">년 
                              ...
                              <input type="radio" name="sol_Flag" id="sol_Flag_Sun" checked="checked" value="양력">
                              양력 
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="391"> <input type="radio" name="sex" id="sex_Man" value="남자" checked="checked">
                              남자 
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="391"> <input type="radio" name="marry_Flag" id="marry_Flag_No" value="무" checked="checked">
                              미혼 
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input id="work_Year" name="work_Year" type="text" value="${sawonDTO.work_Year}" size="10" maxlength="2"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392">
                              <input name="address" id="address" type="text" value="${sawonDTO.address}" size="40" maxlength="40"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input name="email" id="email" type="text" value="${sawonDTO.email}" size="20" maxlength="30"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input id="liquor" name="liquor" type="text" size="20" value="${sawonDTO.liquor}" maxlength="10"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><button type="button" id="uploadExcel">업로드</button>
                            </td>
                          </tr> 	
                        </table></td>
                    </tr>
        ...
        <tr>
          <td height="3" align="center"><table width="107" border="0" cellpadding="1" cellspacing="1">
            <tr>
              <td width="49">
              	<button type="button" id="bt_insertSubmit" style="border:0px; background-color:white;"><img src="${pageContext.request.contextPath}/resources/image/bt_remove.gif" width="49" height="18"></button>
             </td>
              <td width="51">
